...
import AddCategory from '@/components/pharmacyAdmin/AddCat'
import AddProductModal from '@/components/pharmacyAdmin/AddProductModal'
import AddDiscountModal from '@/components/pharmacyAdmin/AddDiscountModal'
